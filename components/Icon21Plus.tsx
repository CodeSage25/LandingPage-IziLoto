// components/Icon21Plus.tsx — VERSION FINALE CORRIGÉE
import React from "react";

interface Icon21PlusProps {
  size?: number;
  color?: string;
}

export default function Icon21Plus({
  size = 24,
  color = "white",
}: Icon21PlusProps) {
  return (
